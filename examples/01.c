...
static basic26_FunctionResult var_function(const basic26_CallInfo *info, size_t argc, const basic26_Value *argv)
{
    UNUSED(info);
    ...
    CHECK(basic26_State_set_var(info->state, argv[0].as.string_id, &(basic26_Value){
...
static basic26_FunctionResult print_function(const basic26_CallInfo *info, size_t argc, const basic26_Value *argv)
{
    UNUSED(info);
...
static basic26_FunctionResult new_function(const basic26_CallInfo *info, size_t argc, const basic26_Value *argv)
{
    UNUSED(info);

    if (argc != 2 || argv[0].type != BASIC26_VALUE_TYPE_SYMBOL || argv[1].type != BASIC26_VALUE_TYPE_INT)
    {
        return BASIC26_FUNCTION_RESULT_ERROR;
    }
    ...
    CHECK(basic26_State_set_var(state, argv[0].as.symbol_id, &(basic26_Value){
...
// delete.
static basic26_FunctionResult del_function(const basic26_CallInfo *info, size_t argc, const basic26_Value *argv)
{
    UNUSED(info);
    ...
    if (basic26_State_get_var(state, argv[0].as.symbol_id, &target_var) != BASIC26_RESULT_OK || target_var.type != BASIC26_VALUE_TYPE_OBJECT)
    {
        return BASIC26_FUNCTION_RESULT_ERROR;
    }
...
static basic26_FunctionResult wait_function(const basic26_CallInfo *info, size_t argc, const basic26_Value *argv)
{
    UNUSED(info);
